...
{\bf Click-Bait Blocker} {\em (unreleased)}\
\\
\begin{tabular}{l l l l l}
...
\begin{itemize}
  ...
  \item Aimed at Facebook and Twitter
  \item ConvNetJS implements in-browser neural nets to improve filtering
  \item Work is still progressing on training a deep supervised neural network
...
\begin{itemize}
  ...
  \item Make use of VPS in Frankfurt, Germany as a mirror
...
\begin{itemize}
  ...
  \item Travis CI was used for continuous integration testing à la Agile

...
\vspace*{-.17in}
\begin{tabular}{l l l}
%  B.S., Computer Engineering & B.E., Electrical Engineering & Minor, Mathematics
  Bachelor of Science in Computer Engineering, Computer Science Track \\
%Major GPR: 3.417 Cumulative GPR: 2.658
  %Major GPR: 3.4 Cumulative GPR: 2.7
\end{tabular}
%\begin{list1}
...
{\renewcommand{\arraystretch}{1.25}
  ...
  \begin{tabular}{l l l}
    ...
    & {\bf Languages} C/C++/Objective-C Bash Ruby \\ % Haskell Elisp Scheme \\

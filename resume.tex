...
\name{{\fontsize{28pt}{30pt}\selectfont {\color{Black}Sam Gwydir}}}
\hfill
\vspace*{-.45in}
\begin{tabular}{l r}
...
\begin{itemize}
  ...
  %% \item Worked on all parts of a cluster scheduled, distributed cloud platform, including proposal, design, implementation and testing
  ...
  \item Improved memory deallocation by 100,000x to improve Postgres performance %%(illumos)
  \item Patched Postgres 9.4 to use Intimate Shared Memory for more effective virtual memory usage %%(MANATEE-371)
\end{itemize}
%% \vspace{-.10in}
...
%% {\bf J\&E Construction Co.} \hfill {\bf June 2015 - June 2016} \
%% \\
%% {\bf Systems Engineer}
%% \\
...
%% \begin{tabular}{l} 
%% {\em https://github.com/gwydirsam/bsd-coredump-history} \
%% \end{tabular}
%% \\
\vspace{-.16in}
\begin{itemize}
